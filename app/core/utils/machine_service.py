...
# from app.core.exceptions import DuplicateValueException, NotFoundException, UnprocessableEntity

# # from app.models import Machine
# from app.core.db import Transactional, session
# from app.core.utils.validator import Validation
